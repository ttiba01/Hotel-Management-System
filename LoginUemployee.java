...
import GUI.UserShowEmployee;
import Files.FileIOemployee;


public class LoginUemployee extends JFrame implements ActionListener{
	...
	public LoginUemployee(){
		...
		userLabel = new JLabel("Do Not Have Any Account?");
	...
	public void actionPerformed(ActionEvent e){
		if(e.getSource() == loginBtn){
			...
			if(FileIOemployee.checkUser(userName,password)){	
				JOptionPane.showMessageDialog(this,"Welcome "+ userTextField.getText() +" :)");
				 
				UserShowEmployee userShowEmployee= new UserShowEmployee();
				this.dispose();
