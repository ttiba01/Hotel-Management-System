...
import GUI.LoginUemployee;
import Files.FileIOemployee;
import java.io.FileWriter;
import java.io.IOException;

public class RegistrationFormEmployee extends JFrame implements ActionListener{
   ...
   public void actionPerformed(ActionEvent e){
	if(submitBtn == e.getSource()){
	       ...
	       LoginUemployee loginUemployee = new LoginUemployee();
		   this.dispose();
   }
   }
}