...
public class EntitySelection extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == roomButton) {
            ...
            JOptionPane.showMessageDialog(this, "Employee feature is not available yet!");
        } else if (e.getSource() == clientButton) {
            JOptionPane.showMessageDialog(this, "Client feature is not available yet!");
        }
    }
